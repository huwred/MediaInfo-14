...
namespace MediaInfo._17.Controllers
{
    [ApiVersion("1.0")]
    [ApiExplorerSettings(GroupName = "MediaInfo._17")]
    public class MediaInfo17ApiController : MediaInfo17ApiControllerBase
    {
        private readonly IBackOfficeSecurityAccessor _backOfficeSecurityAccessor;

        public MediaInfo17ApiController(IBackOfficeSecurityAccessor backOfficeSecurityAccessor)
        {
