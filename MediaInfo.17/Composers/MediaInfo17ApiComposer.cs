...
namespace MediaInfo._17.Composers
{
    public class MediaInfo17ApiComposer : IComposer
    {
        public void Compose(IUmbracoBuilder builder)
        {
            ...
            builder.Services.Configure<SwaggerGenOptions>(opt =>
            {
                ...
                {
                    Title = "Media Info 17Backoffice API",
                    Version = "1.0",
                ...
                opt.OperationFilter<MediaInfo17OperationSecurityFilter>();
            });
        }

        public class MediaInfo17OperationSecurityFilter : BackOfficeSecurityRequirementsOperationFilterBase
        {
        ...
        public class CustomOperationHandler : OperationIdHandler
        {
            ...
            {
                return controllerActionDescriptor.ControllerTypeInfo.Namespace?.StartsWith("MediaInfo._17.Controllers", comparisonType: StringComparison.InvariantCultureIgnoreCase) is true;
            }
